...
<div class="page">
  <div class="container">
    ...
    <div class="row">
      <div class="col-xs-4">
        <div class="preview"><a style="background-image: url(/layout/images/car.jpg)" href="#" class="preview__image"></a><a href="#" class="preview__title">Название автомобиля в две строки</a>
          <p class="preview__text">1942 году перед работниками столичного автозавода, эвакуированного на Урал, была поставлена задача создать новое поколение представительского лимузина. Об автомобиле ЗИС-110 рассказывает материал «Герои Советского Союза. </p>
        </div>
      </div>
      <div class="col-xs-4">
        <div class="preview"><a style="background-image: url(/layout/images/car.jpg)" href="#" class="preview__image"></a><a href="#" class="preview__title">Название автомобиля в две строки</a>
